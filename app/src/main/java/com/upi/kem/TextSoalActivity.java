...
public class TextSoalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterText.setOnItemClickListener(new AdapterText.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                Intent intent = new Intent(TextSoalActivity.this,SkorActivity.class);
    ...
    private void getListTExt() {
        ...
        AndroidNetworking.get(LIST_TEXT)
                .build()
                .getAsObject(TextResponse.class, new ParsedRequestListener() {
                    ...
                    public void onError(ANError anError) {
                        refresh.setRefreshing(false);
                        CommonUtil.showToast(TextSoalActivity.this, "Harap Cek Koneksi Internet Anda");
                    }
                });
    }
        ...
        builder.setMessage("Apakah Anda Sudah siap ?")
                .setPositiveButton("YA", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(TextSoalActivity.this, DetailTextActivity.class);
                        intent.putExtra("id_soal", adapterText.getItem(position).getId());
