...
public class AdapterSoalAdmin extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    List<DataItemSoal> itemText;
    ...
    public AdapterSoalAdmin(Context ctx) {
        this.ctx = ctx;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_admin_pertanyaan, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            view.judul.setText(itemText.get(position).getPertanyaan());
    ...
    public void add(DataItemSoal dataItemRapatK3) {
        itemText.add(dataItemRapatK3);
        notifyItemInserted(itemText.size() + 1);
    }

    public void addAll(List<DataItemSoal> dataItemRapatK3List) {
        for (DataItemSoal rapatK3 : dataItemRapatK3List) {
            add(rapatK3);
        }
    }
    ...
    public void swap(List<DataItemSoal> datas) {
    ...
    public DataItemSoal getItem(int pos) {
